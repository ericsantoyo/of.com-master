...
// import { SubmitDocument } from '@/app/dashboard/documents/[id]/(components)/SubmitDocument';
  ...
  return (
    <div className="flex flex-col items-end w-full">
      <div className="flex justify-center items-center gap-3">
        <a href={`/dashboard/preview/${params?.slug}`}>
        ...
        <BubbleMenu editor={editor!} tippyOptions={{ duration: 100 }}>
          <button
            ...
            className={
              editor?.isActive("bold")
                ...
                : "border-black px-1 border rounded text-black bg-white"
            }
          >
            bold
          </button>
          <button
            ...
            className={
              editor?.isActive("italic")
                ? "is-active border rounded bg-black text-white border-black px-1 mx-1"
                : "border-black px-1 border rounded text-black bg-white mx-1"
            }
          >
            italic
          </button>
          ...
          <button
            ...
            className={
              editor?.isActive("link")
                ? "is-active border rounded bg-black text-white border-black px-1 mx-1"
                : "border-black px-1 mx-1 border rounded text-black bg-white"
            }
          >
            link
          </button>
