...
const navItems = [
  ...
  { href: "/dashboard/documents", label: "My Documents", icon: BookCheck },
...
export default function DashboardNav() {
  ...
  return (
    <div className="md:block hidden border-r h-full">
              ...
              <div key={href}>
                <Link
                  ...
                  className={clsx(
                    ...
                    {
                      "bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-50": pathname === href || (href !== "/dashboard" && pathname.startsWith(href))
                    }
                  )}
                  href={href}
                >
