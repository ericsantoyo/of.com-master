...
export default async function UserStatusBar() {
  ...
  return user ? (
    ...
    >
      <Button
        variant="green"
        className="hidden md:flex gap-2 justify-center items-center  whitespace-nowrap"
      >
        <LogOut size={16} />
      ...
      <Button
        variant="green"
        className="md:hidden flex gap-2 justify-center items-center  whitespace-nowrap"
      >
        <LogIn size={16} />
